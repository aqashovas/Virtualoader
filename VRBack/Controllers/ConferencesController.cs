...
namespace VRBack.Controllers
{
    ...
    {
        private VirtualLoaderContext db = new VirtualLoaderContext();
        ...
        public ActionResult Create([Bind(Include = "Id,Link1,Link2,Text1")] Conference conference)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Link1,Link2,Text1")] Conference conference)
        {
            if (ModelState.IsValid)
            {
